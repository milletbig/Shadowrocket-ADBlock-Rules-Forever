...
# ==========================================
# ==========================================
# 🚫 拦截 QUIC 流量 (强制 YouTube/Instagram 等退回 TCP)
# ==========================================
# 拦截所有发往 443 端口的 UDP 流量，no-resolve 表示不需要消耗时间解析域名
IP-CIDR,0.0.0.0/0,REJECT,no-resolve,UDP-PORT:443
IP-CIDR6,::/0,REJECT,no-resolve,UDP-PORT:443
